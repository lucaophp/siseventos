            ...
            <form method="POST" enctype="multipart/form-data" id="formcadastro">
                ...
                <table width="600" border="0px">
                    ...
                    <tr>			
                        ...
                        <td>&nbsp;</td>
                        <td align="right"><label class="titulo"><strong>Cargo: </strong></label></td>
                        <td><select class="det" name="idCargo" id="cargo">
                                <option value=""> Selecione um Cargo </option>
                                <?php foreach ($cargos as $cargo): ?>
                                    <option value="<?php echo $cargo->getIdCargo(); ?>"> <?php echo $cargo->getNomeFuncao(); ?> </option>
                                <?php endforeach; ?>
                            </select></td>
                    </tr>
                    <tr>
