<div id="boxtudo">
	...
	<div id="box2" >
		<div id="conteudo-box2" >
			<p class="titulo"><strong>CADASTRO DE CARGO</strong></p><br>
			
			<?php
				if(!count($error) && $cargo->getidCargo() > 0) { //Se o ID do departamento for positivo (dep cadastrada com sucesso)		
					echo "Você inseriu com sucesso o Cargo '{$cargo->getNomeFuncao()}'<br>";
					echo "<br> <a href='empresa/estrutura_gerenciar'> Voltar </a>";
				}
				else //Se nao foi cadastrada
				{
					echo 'Falha ao inserir cargo no banco de dados!<br>';
