  ...
  <div id="box2" >
    <div id="conteudo-box2" >
      <form method="POST" enctype="multipart/form-data" id="formcadastro">
        <p class="titulo"><strong>CADASTRAR CARGO</strong></p><br>  
        <table width="600" border="0px">
          <tr>      
            <td width="150" height="39" align="right"><label class="titulo"><strong>Nome do Cargo: </strong></label></td>
            ...
            <td><input class="intup" type="text" name="nivel" id="nivel"></td>
          </tr><tr>      
            ...
            <select class="det" name="departamento" id="departamento">
              ...
              <?php 
                foreach($deps as $dep) {
                  echo "<option value='{$dep->getidDep()}''> {$dep->getNome()} </option>";
                }
              ?>
              </select>
            </td>
