		...
		<div id="conteudo-box2" >
			...
			<?php
				if(!count($error) && $empresa->getidEmpresa() > 0) { //Se o ID da empresa for positivo (empresa cadastrada com sucesso)		
					echo "Você inseriu com sucesso a empresa '{$empresa->getNome()}' 
						 com ID: {$empresa->getidEmpresa()} no banco de dados! <br>";
				}
				else //Se nao foi cadastrada
				{
					echo 'Falha ao inserir empresa no banco de dados!<br>';
