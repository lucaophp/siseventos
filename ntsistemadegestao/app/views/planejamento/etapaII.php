<div id="boxtudo">
	...
	<div id="box2" >
		<div id="conteudo-box2" >
			<p class="titulo"><strong>ETAPA II - ESTABELECIMENTO DA DIRETRIZ ORGANIZACIONAL</strong></p><br>
            <form action="planejamento/etapaII" method="POST">
            	...
            	for($i = 0; $i < 1; $i++)
            	{
					...
					<tr><td><table>
						<tr>
							...
							<td> <input name="titulo[<?php echo $i;?>]" type="text" placeholder="Titulo do Tópico" class="intup" style="width: 378px;"/></td>
						</tr><tr>
							<td> <label class="titulo"><strong>Conteudo:</strong></label></td> 
							<td> <textarea name="missao[<?php echo $i;?>]" cols="60" class="textarea" id="infra-estrutura"></textarea> </td>
						</tr>
					</table></td></tr>
					<tr><td><br></td></tr>
					<?php
