<div id="boxtudo">
	...
	<div id="box2" >
		<div id="conteudo-box2" >
			...
			<p class="titulo"><strong>A) Ambiente Geral</strong></p>
          ...
          <table width="80%" border="0px" id="tCampos" name="tCampos">
            ...
            */ ?>
			...
			<tr>
				  <td colspan="3" align="right"><a href="planejamento/I_operacional"><img src="http://www.redecultura.com.br/entrar_files/ceta.png"  alt="" width="55" height="55"/></a></td>
			  </tr>
            <tr>
