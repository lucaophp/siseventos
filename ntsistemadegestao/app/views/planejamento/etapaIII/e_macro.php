<div id="boxtudo">
	...
	<div id="box2" >
		<div id="conteudo-box2" >
			...
			<p class="titulo"><strong>E) Formulação de Estrátegias Macro </strong></p>
...
<br><table width="80%" border="0px" id="tCampos" name="tCampos">
          ...
          <table width="419" border="0" id="butoes">
			<tr>
				  <td colspan="3" align="right"><a href="planejamento/III_alternativa"><img src="http://www.redecultura.com.br/entrar_files/ceta.png"  alt="" width="55" height="55"/></a></td>
			  </tr>
            <tr>
