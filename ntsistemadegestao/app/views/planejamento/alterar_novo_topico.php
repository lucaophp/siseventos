	...
	<div id="box2" >
        <form action="planejamento/novo_topico" method="post" id="tCampos">
			<div id="conteudo-box2" >
				<p class="titulo"><strong>Atualizar Tópico</strong></p><br>
				<input name="idTopico" type="hidden" value="<?php echo $id;?>">
	            <input name="nome" type="text" value="<?php echo $topico['nome']?>" placeholder="Digite o titulo do tópico" class="intup" style="width:100%;" required>
	            <input name="nivel" type="number" value="<?php echo $topico['nivel']?>" placeholder="Digite a ordem do tópico" class="intup" style="width:100%;" required>
	            <input type="submit" name="atualiza" id="submit" class="botoes-salvar" value="Salvar"> 
			</div>
        </form>
