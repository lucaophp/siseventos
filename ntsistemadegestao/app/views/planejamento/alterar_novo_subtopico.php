<div id="boxtudo">
    ...
    <div id="box2" >
        <form action="planejamento/novo_sub_topico/<?php echo getParam(2); ?>" method="post" id="tCampos">
            <div id="conteudo-box2" >
                <p class="titulo"><strong>Alterar Sub-Tópico</strong></p><br>
                <input name="idSubtopico" type="hidden"value="<?php echo getParam(4)?>">
                <input name="nome" type="text" value="<?php echo $subtopico->getNomeSubtopico();?>" class="intup" style="width:100%;" required>
                <input name="nivel" type="number" value="<?php echo $subtopico->getNivel();?>" class="intup" style="width:100%;" required>
