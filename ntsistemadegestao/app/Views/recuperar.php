	...
	<body>	
		<div id="divLogin">
			<form action="login/recuperar" method="POST">
				<div id='divLogin-Title'> Recuperar Senha </div>
				<div id='divLogin-Content'>
					...
					<table align="center" class='table-login'>
						...
						<tr> <td>Codigo: </td> <td> <input type="text" id="codigo" name="codigo" size="15"> </td> </tr>
						<tr> <td>Nova Senha: </td> <td> <input type="password" id="nsenha" name="nsenha" size="15"> </td> </tr>
					</table>
					<input class='button-login' type="submit" id="recuperar" name="recuperar" value="Recuperar">
