	...
	<body>	
		<div id="divLogin">
			<form action="login" method="POST">
				<div id='divLogin-Title'> Login </div>
				<div id='divLogin-Content'>
					...
					<table align="center" class='table-login'>
						...
						<tr> <td>Senha: </td> <td> <input type="password" id="senha" name="senha" size="15"> </td> </tr>
					</table>
					<input class='button-login' type="submit" id="logar" name="logar" value="Logar">
					<p><a href="login/esqueci">Esqueci a Senha</a></p>
				</div>
			</form>
		</div>
	</body>
