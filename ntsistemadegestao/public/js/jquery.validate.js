...
jQuery.extend(jQuery.validator.messages, {
        ...
        digits: "forne&ccedil;a apenas d&iacute;gitos.",
        creditcard: "Cart&atilde;o de cr&eacute;dito inv&aacute;lido.",
        equalTo: "Por favor, forne&ccedil;a o mesmo valor novamente.",
        accept: "Extens&atilde;o v&aacute;lida.",
        maxlength: jQuery.validator.format("Maximo: {0} caracteres."),
        minlength: jQuery.validator.format("Minimo: {0} caracteres."),
        rangelength: jQuery.validator.format("Tamanho de {0} a {1}"),
        range: jQuery.validator.format("O valor deve esta entre {0} e {1}."),
